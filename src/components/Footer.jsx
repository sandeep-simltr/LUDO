...
export default function Footer() {
  return (
    <footer className="relative border-t border-slate-900 bg-slate-950/80 backdrop-blur-md pt-20 pb-10 text-slate-500 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10 mb-16">
        {/* Brand Column */}
        ...
        {/* Links Column 1 */}
        <div>
          <h4 className="text-xs font-bold text-slate-350 uppercase tracking-widest mb-4">Lobby Nav</h4>
        ...
        {/* Links Column 2 */}
        <div>
          <h4 className="text-xs font-bold text-slate-350 uppercase tracking-widest mb-4">Security</h4>
          <ul className="space-y-2.5 text-xs">
        ...
        <div className="space-y-4">
          <h4 className="text-xs font-bold text-slate-350 uppercase tracking-widest mb-4">Certifications</h4>
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-2.5 bg-slate-900/60 border border-slate-850 p-2.5 rounded-xl">
              <ShieldCheck size={16} className="text-emerald-400" />
              <div className="text-[10px]">
                <p className="font-bold text-slate-200">100% Secure Audited</p>
                <p className="text-slate-500">JWT & Auth Certified</p>
              </div>
            </div>
            <div className="flex items-center gap-2.5 bg-slate-900/60 border border-slate-850 p-2.5 rounded-xl">
              ...
              <div className="text-[10px]">
                ...
                <p className="text-slate-500">React v19 + Tailwind v4</p>
              </div>
            </div>
          </div>
        </div>
